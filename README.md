# Available .IMMO One-Word Domains (13,170)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-13%2C170%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **13,170 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 13,170 domains · **Median ask:** $18.94 · **High-demand under $2,500:** 2
...
| own.immo     | available | —         | —             | high           | low    | 3      | —                 |
| attack.immo  | available | $14.99    | —             | high           | low    | 6      | name.com          |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 13,170 live domains                        |
...
> Unique Domains. *Available .IMMO One-Word Domains*. Version 2026-08-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
